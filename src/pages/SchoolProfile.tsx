...
function getProfile(): SchoolProfile {
    ...
    <div className="space-y-6">
      ...
      <div className="rounded-xl border border-border bg-card p-6 shadow-sm space-y-5">
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          ...
          <div className="space-y-1.5">
            <label className="text-sm font-medium text-foreground">NPSN</label>
            <Input value={profile.npsn} onChange={(e) => update("npsn", e.target.value)} />
          </div>
          ...
          <div className="space-y-1.5 sm:col-span-2">
            <label className="text-sm font-medium text-foreground">Kepala Sekolah</label>
            <Input value={profile.principal} onChange={(e) => update("principal", e.target.value)} />
          </div>
        </div>
